...
$(function(){
  ...
  // Kích hoạt khi modal mở để load PDF
  $('#cvModal').on('show.bs.modal', function () {
    var pdfUrl = 'https://docs.google.com/gview?url=https://duykienphan.github.io/assets/img/Phd_NgheNhanTruong_CV.pdf&embedded=true';
    $('#pdfViewer').attr('src', pdfUrl);
  });

  // Xóa src khi modal đóng để tránh tải lại không cần thiết
  $('#cvModal').on('hide.bs.modal', function () {
    $('#pdfViewer').attr('src', '');
  });
});